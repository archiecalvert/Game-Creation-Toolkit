...
namespace Game_Creation_Toolkit.Game_Engine.Menus.MessageBoxes.ScriptMenu.MenuItems
{
    public class TextureItem : ScriptItem
    {
        ...
        public TextureItem(JObject TextureData) : base(TextureData, 510, true)
        {
            ...
            BlankTexture.SetData(new[] { AccentColour }); //sets the textures data to white
            ...
            ChangeTextureBtn = new Button(BlankTexture, new Vector2(BackgroundBounds.X + 25, ScaleY.FieldBounds.Bottom + 10), new Vector2(BackgroundBounds.Width - 40, 60));
            SaveBtn = new Button(BlankTexture, new Vector2(BackgroundBounds.X + 25, ChangeTextureBtn.ButtonRect.Bottom + 10), new Vector2(BackgroundBounds.Width - 40, 60));
        ...
        public override void Draw()
        {
            ...
            Core.DrawAccent(ChangeTextureBtn.ButtonRect, 7, Core.ButtonDepth + 0.01f);
            ...
            text: "Change Texture",
                            position: new Vector2(ChangeTextureBtn.ButtonRect.X + ChangeTextureBtn.ButtonRect.Width/2 - 70, ChangeTextureBtn.ButtonRect.Y + 15),
                            color: TextColour,
                            rotation: 0f,
                            origin: Vector2.Zero,
                            scale: 0.35f,
            ...
            Core._spriteBatch.DrawString(spriteFont: TextFont,
            text: "Width Scale:",
                            position: new Vector2(BackgroundBounds.X + 10, BackgroundBounds.Y + 267),
                            color: TextColour,
                            rotation: 0f,
                            origin: Vector2.Zero,
                            scale: 0.35f,
            ...
            Core._spriteBatch.DrawString(spriteFont: TextFont,
            text: "Height Scale:",
                            position: new Vector2(BackgroundBounds.X + 10, BackgroundBounds.Y + 317),
                            color: TextColour,
                            rotation: 0f,
                            origin: Vector2.Zero,
                            scale: 0.35f,
