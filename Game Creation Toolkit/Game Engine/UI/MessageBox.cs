...
namespace Game_Creation_Toolkit.Game_Engine.UI
{
    public class MessageBox
    {
        ...
        Color WindowColor = new Color(58,58,58);
        public MessageBox(int x, int y, int width, int height)
        {
            ...
            CloseBtn = new Button(Core._content.Load<Texture2D>("Toolkit/Assets/InitialMenu/Cancel"), new Vector2(Coordinates.X + (Dimensions.X/2) - (0.6f*Core._content.Load<Texture2D>("Toolkit/Assets/InitialMenu/Cancel").Width/2) , Coordinates.Y + Dimensions.Y - 60), new(0.6f));
        ...
        public void Draw()
        {
            ...
            Core._spriteBatch.Draw(texture: BlankTexture, //DRAWS THE BORDER
            ...
            Core._spriteBatch.Draw(texture: BlankTexture, //DRAWS THE INNER BOX
                ...
                SpriteEffects.None,
                layerDepth: Core.MessageDialogueDepth); //draws the button to the screen);
            Core._spriteBatch.DrawString(Font, Title, Coordinates + new Vector2(25,12), Color.White, 0f, Vector2.Zero, 0.6f, SpriteEffects.None, Core.MessageDialogueDepth - 0.01f);
            Core._spriteBatch.DrawString(Font, Text, Coordinates + new Vector2(25, 67), Color.White, 0f, Vector2.Zero, 0.4f, SpriteEffects.None, Core.MessageDialogueDepth - 0.01f);
        }
        public void Update()
        {
